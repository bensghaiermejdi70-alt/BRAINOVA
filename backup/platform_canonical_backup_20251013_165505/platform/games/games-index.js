const GamesIndex = (()=>{
  ...
  2: { id: 2, title: 'Quantum Memory', description: 'Memory quantique — retrouvez les paires d\'états', icon: '🧠', tags: ['memoire','puzzle','memory'], players: '1-2', duration: '2-8 min', file: 'jeux2.html' },
