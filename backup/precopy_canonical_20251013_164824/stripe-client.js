...
export async function startCheckout(items, metadata, opts = {}){
  ...
  const defaultSuccess = './global_platform_canonical.html?bundle_purchased=1&session_id={CHECKOUT_SESSION_ID}';
  const defaultCancel = './global_platform_canonical.html?checkout=cancel';
